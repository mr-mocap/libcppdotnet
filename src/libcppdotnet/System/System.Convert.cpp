...
inline std::string Convert::ToBase64String(std::string_view input_ascii_string)
{
...
const std::uint32_t    Base85SpecialCaseValue1 = 0u;
const std::uint32_t    Base85SpecialCaseValue2 = 0x20202020u; // All spaces
