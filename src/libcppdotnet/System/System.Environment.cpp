...
std::string_view ContainsSurroundingTokens(std::string_view input,
...
EnvironmentVariableReference ContainsEnvironmentVariableReference(std::string_view input)
{
    if ( !input.empty() )
    {
